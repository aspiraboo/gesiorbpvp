												...
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">O RushEvent &eacute; considerado um dos melhores eventos de PVP devido a liberdade da quantidade de players permitidos para o evento, contamos com uma mapa exclusivo e muito bem elaborado para um pvp de alta qualidade e automaticamente lhes oferecendo muita divers&atilde;o. Veja abaixo algumas informa&ccedil;&otilde;es do evento:</div>
															</td>
														</tr>
													</table>
												</div>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">O evento vai funcionar todos os dias às 10:00 e 22:00hrs.</div>
															</td>
														</tr>
													</table>
												</div>
													...
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">
																<p>Quando o evento iniciar vai aparecer uma mensagem no <i>broadcast</i> informando o in&iacute;cio do evento e o teleporte aparece no templo que leva para uma sala de espera, &eacute; feita uma sele&ccedil;&atilde;o autom&aacute;tica de players, balanceada por level, para distribuir em dois times, azul e vemelho.<br> <small>(<i>Clique na imagem pra ampliar</i>.)</small></p></div>
															</td>
															<td width="20%">
																<a class="fancybox-media" href="/images/battlefield/ctf.png">
																	<img src="images/battlefield/ctf.png" width="180px">
																</a>
															</td>
														</tr>
													</table>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">&Eacute; necess&aacute;rio ser level 400 ou mais para participar.</div>
															</td>
														</tr>
													</table>
												</div>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">&Eacute; proibido ficar invisivel no evento.</div>
															</td>
														</tr>
													</table>
												</div>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">O evento comporta no min&iacute;mo 4 player e no m&aacute;ximo 100.</div>
															</td>
														</tr>
													</table>
												</div>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">O evento s&oacute; finaliza quando um dos dois times atigem o limite de frags m&aacute;ximo, 100 frags.</div>
															</td>
														</tr>
													</table>
												</div>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">
																Veja abaixo o mapa utilizado para as batalhas do RushEvent:</div>
															</td>
														</tr>
													</table>
												</div>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><center>
																<a class="fancybox-media" href="/images/rushevent/rushevent.jpg">
																	<img src="/images/rushevent/rushevent.jpg" width="750px" border="1">
																</a>
																</center>
															</td>
														</tr>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
																<td><b>Pr&ecirc;mios:</b></td><td width="95%"><img src="images/npcmega/3event.png"></td>
														</tr>
													</table>
												</div>
											</div>
											...
											<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#D4C0A1;" >
															<td><div style="text-align: justify;">
																<b>Descri&ccedil;&atilde;o:</b> Pode ganhar 3 Event Coin.</div>
															</td>
														</tr>
													</table>
												</div>
												...
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%">
														<tr style="background-color:#505050;" >
															<td>
																<center><font color="white"><b>-=RushEvent PvP FULL=-</b></font></center>
															</td>
														</tr>
													</table>
												</div>
