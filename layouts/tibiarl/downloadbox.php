<div id="Loginbox">
  ...
  <div id="LoginButtonContainer" style="background-image:url(<?PHP echo $layout_name; ?>/images/loginbox/loginbox-textfield-background.gif)">
    <br>
    <div id="DownloadNowContainer" style="margin-top: 7px;"><form class="MediumButtonForm" action="?subtopic=download" method="post"><input type="hidden" name="page" value="overview"><div class="MediumButtonBackground" style="background-image:url(<?PHP echo $layout_name; ?>/images/buttons/mediumbutton.gif)" onmouseover="MouseOverMediumButton(this);" onmouseout="MouseOutMediumButton(this);"><div class="MediumButtonOver" style="background-image: url(<?PHP echo $layout_name; ?>/images/buttons/mediumbutton-over.gif); visibility: hidden;" onmouseover="MouseOverMediumButton(this);" onmouseout="MouseOutMediumButton(this);"></div><input class="MediumButtonText" type="image" name="Download Now" alt="Download Now" src="<?PHP echo $layout_name; ?>/images/buttons/mediumbutton_download.png"></div></form>
    </div>
  </div>
